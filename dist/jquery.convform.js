...
ConvState.prototype.answerWith = function(answerText, answerObject) {
    console.log('previous answer: ', answerObject, this.current.input);
    ...
    if(this.current.input.hasOwnProperty('name')){
        ...
        if(typeof answerObject == 'string') {
           ...
           if(this.current.input.name==="name"){
            username=answerObject.slice();
           }
    ...
    if(this.current.input.type == 'password'){
        ...
        check(answerObject);
        //console.log(answerObject, answerText);
